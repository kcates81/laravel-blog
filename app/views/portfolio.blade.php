        ...
        <ul class="slides">
            <li>
                ...
                <div class="caption left-align">
                    ...
                    <h5>Built using PHP, MySQL, HTML, Materialize CSS, and Custom CSS</h5>
                </div>
            </li>
            <li>
            ...
            <li>
                ...
                <div class="caption right-align">
                    ...
                    <h5>Built using jQuery, HTML, Materialize CSS, Custom CSS, Google Map API, and Open Weather Map API</h5>
                </div>
            </li>
            <li>
                <a href="https://github.com/Freelancer-Invoice-Tool/flit.dev" target="_blank"><img class="responsive-img" src="/img/screenshots/flit.png"></a>
                <div class="caption right-align">
                    <h3><strong>Capstone Project</strong></h3> 
                    <h5>Built using Laravel, MySQL, jQuery, HTML, Materialize CSS, Custom CSS, Mailgun API, and Stripe API</h5> 
                </div>
            </li>
        </ul>
    </div>
